...
<body>
	...
	<form action="#" name="member" method="post">
		...
		<p> 연락처 : <select name ="phone1">
				...
				<select>-<input type="text" maxlength="4" size="4" name="phone2">-<input type="text" maxlenght="4" size="4" name="phone3"></select>
		</select>
		...
		<p> <textarea name="comment" cols="30" row="3" placeholder ="가입 인사 입력"></textarea>
